...
{
  // NORTHWNDContext sınıfın instance alınınca veri tabanı bağlantısı yapabiliriz.
  public partial class NORTHWNDContext : DbContext
    ...
    // veri tabanındaki tablolar classlara çevrildi.
    ...
    /// <summary>
    /// EF de konfigürasyonları yönettiğimiz method
    /// </summary>
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    /// <summary>
    /// class nesnelerinin program tarafında hangi nesenlere maplendiğini veri tabanındaki kuralları yönettiğimiz method.
    /// </summary>
    /// <param name="modelBuilder"></param>
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AlphabeticalListOfProduct>(entity =>
            {
                ...
                entity.ToView("Alphabetical list of products"); // view
            ...
            {
                entity.ToTable("PersonEmailAddress");
                ...
                entity.HasOne(d => d.Person)
                    ...
                    .HasConstraintName("FK_PersonEmailAddress_Person");
            });
